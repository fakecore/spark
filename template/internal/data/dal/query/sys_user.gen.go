...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.Birthday = field.NewInt32(tableName, "birthday")
	...
	_sysUser.IsAdmin = field.NewInt32(tableName, "is_admin")
	_sysUser.Address = field.NewString(tableName, "address")
	_sysUser.Remark = field.NewString(tableName, "remark")
	_sysUser.LastLoginIP = field.NewString(tableName, "last_login_ip")
	_sysUser.LastLoginTime = field.NewInt64(tableName, "last_login_time")
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.Birthday = field.NewInt32(table, "birthday")
	...
	s.LastLoginTime = field.NewInt64(table, "last_login_time")
