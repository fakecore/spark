...
func newSysPost(db *gorm.DB, opts ...gen.DOOption) sysPost {
	...
	_sysPost.CreatedBy = field.NewInt64(tableName, "created_by")
	_sysPost.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_sysPost.DeletedBy = field.NewInt64(tableName, "deleted_by")
	_sysPost.CreatedAt = field.NewInt64(tableName, "created_at")
	_sysPost.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_sysPost.DeletedAt = field.NewUint(tableName, "deleted_at")
