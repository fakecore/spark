...
func newSysConfig(db *gorm.DB, opts ...gen.DOOption) sysConfig {
	...
	_sysConfig.CreatedAt = field.NewInt64(tableName, "created_at")
	_sysConfig.UpdatedAt = field.NewInt64(tableName, "updated_at")
	...
	_sysConfig.Kind = field.NewInt32(tableName, "kind")
