...
func newSysLoginLog(db *gorm.DB, opts ...gen.DOOption) sysLoginLog {
	...
	_sysLoginLog.CreatedBy = field.NewInt64(tableName, "created_by")
	_sysLoginLog.CreatedAt = field.NewInt64(tableName, "created_at")
	...
	_sysLoginLog.Module = field.NewString(tableName, "module")
