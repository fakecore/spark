...
// Validate checks the field values on AnnouncementInfo with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *AnnouncementInfo) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AnnouncementInfo with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AnnouncementInfoMultiError, or nil if none found.
func (m *AnnouncementInfo) ValidateAll() error {
	return m.validate(true)
}

func (m *AnnouncementInfo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AnnouncementInfoMultiError(errors)
	}

	return nil
}

// AnnouncementInfoMultiError is an error wrapping multiple validation errors
// returned by AnnouncementInfo.ValidateAll() if the designated constraints
// aren't met.
type AnnouncementInfoMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AnnouncementInfoMultiError) Error() string {
...
func (m AnnouncementInfoMultiError) AllErrors() []error { return m }

// AnnouncementInfoValidationError is the validation error returned by
// AnnouncementInfo.Validate if the designated constraints aren't met.
type AnnouncementInfoValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e AnnouncementInfoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AnnouncementInfoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AnnouncementInfoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AnnouncementInfoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AnnouncementInfoValidationError) ErrorName() string { return "AnnouncementInfoValidationError" }

// Error satisfies the builtin error interface
func (e AnnouncementInfoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sAnnouncementInfo.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AnnouncementInfoValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AnnouncementInfoValidationError{}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetAnnouncementReplyValidationError{
					field:  "Announcement",
